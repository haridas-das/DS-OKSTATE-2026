# 2026 Infodengue-Mosqlimate Dengue Forecast Modeling in Brazil
<p align="center">
...
<p align="center">
  <img src="img/BA_VT1_2022_2023_BPI_plot.png" alt="Sprint Planning" width="1000" height="1500">
</p>


<p align="center">
  <img src="img/BA_VT3_2024_2025_BPI_plot.png" alt="Sprint Planning" width="1000" height="1500">
</p>
...
We computed Bootstrap Prediction Intervals (BPI) for the hybrid CNN-LSTM ensemble following the Moving Block Bootstrap (MBB) approach of \cite{Nguinabe2025BootstrapLSTM}. At each forecast level $i \in \{12, 13, 14, 15, 16\}$, the point forecast $\hat{y}^{(i)}$ is first obtained from the hierarchical expanding-window ensemble (Algorithm~\ref{alg:hierarchical_training}), trained on the full original dataset with 100 epochs and stored in \texttt{all\_model\_forecasts}$[i]$. The BPI procedure then quantifies uncertainty around this point forecast non-parametrically, as described in Algorithm~\ref{alg:bpi}.

<p align="center">
  <img src="img/BPI.png" alt="Sprint Planning" width="1000" height="1500">
</p>
